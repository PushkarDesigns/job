                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        {isAuthenticated ? (
                            ...
                            <>
                                ...
                                <a
                                    href="/signup"
                                    className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-lg font-medium shadow-sm hover:from-blue-700 hover:to-purple-700 transition-all duration-300 hover:shadow-md"
                                >
                                    Sign Up
                                </a>
                            </>
