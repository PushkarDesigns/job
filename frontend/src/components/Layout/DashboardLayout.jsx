  ...
  return (
    <>
      <div className="flex h-screen bg-gray-50">
        ...
        >
          {/* Top navbar */}
          <header className="bg-white/30 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-30">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm texyt-gray-500 hidden sm:black">
            ...
            <div className="flex items-center space-x-3">
              ...
              <ProfileDropdown
                ...
                onToggle={(e) => {
                  e?.stopPropagation();
                  setProfileDropdownOpen(prev => !prev); // Uses functional state update for reliability
                }}
                avatar={user?.avatar || ""}
                companyName={user?.company?.name || ""} // Fixed likely data mapping error
                email={user?.email || ""}
                onLogout={logout}
              />
