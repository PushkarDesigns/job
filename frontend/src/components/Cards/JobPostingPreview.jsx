...
const JobPostingPreview = ({ formData, setIsPreview }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 px-4 py-8 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        {/* Header with glassmorphism effect */}
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pl-6">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setIsPreview(false)} className="group flex items-center space-x-2 text-xs md:text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 border-gray-200 hover:border-transparent px-4 py-2 rounded-xl transition-all duration-300 shadow-lg shadow-gray-100 hover:shadow-xl transform hover:-translate-y-0.5">
          ...
          <div className="">
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-0">
                  ...
                  {user?.companyLogo ? (
                    ...
                    <div className="h-20 w-20 bg-gray-20 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              {/* Salary section */}
              <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 shadow-md border border-emerald-100">
                {/* Salary metrics or layout content goes here */}
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between">
                    ...
                    <h1 className="text-sm font-semibold text-gray-900 mb-1">Compensation</h1>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                  {/* Decorative vertical bar from previous step */}
